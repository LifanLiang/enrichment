...
```{r, echo=F}
enrich.ld <- read.table("data/enrich_results/dynamic_vs_static_joint.results", sep="\t", header=T, row.names=1)
temp <- enrich.ld[(nrow(enrich.ld)-11):nrow(enrich.ld),4:5]
annot <- c('NmCp_glut_static_psbulk_ucsc',
 'GABA_static_psbulk_ucsc',
 'NpCm_glut_static_psbulk_ucsc',
 'NPC_static_psbulk_ucsc',
 'GABA_1v0hr_ucsc',
 'GABA_6v0hr_ucsc',
