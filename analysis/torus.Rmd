...
### Pseudo bulk peak sets
Since Siwei provide an updated another peak sets called from pseudo bulk approach, we rerun enrichment analysis. And the results are similar with the previous peak set, though the number of peaks are much bigger (refers to the summary statics page). The non-inducible part of the peaks ("static" in the plot) also dropped performance.
